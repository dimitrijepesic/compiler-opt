# Legacy: a fast feed-forward network trained on greedy-search
# trajectories, superseded by the PPO agents in src/agents/ppo_*.py.
...
class NNAgentFast:
    ...
    def train(self, data_path="legacy/results/greedy_trajectories.json", epochs=300):
        """Full training pipeline."""
        print(f"-- NN Agent (Fast) on {self.benchmark}")

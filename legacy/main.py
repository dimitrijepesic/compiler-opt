# Legacy entry point from an early "RISC-V optimization arena" prototype,
# superseded by the PPO pipeline (scripts/train_ppo_*.py). Kept for
# provenance; not part of the paper's pipeline.
import argparse
import sys
import traceback
from legacy.envs.compiler_env import make_env
from src.agents.greedy import GreedyAgent
from legacy.agents.genetic import GeneticAgent
from legacy.validator import verify_optimization
...
def main():
    ...
    print(f"--- RUNNING: Model={args.model} | Benchmark={args.benchmark} | Target={args.target} ---")
